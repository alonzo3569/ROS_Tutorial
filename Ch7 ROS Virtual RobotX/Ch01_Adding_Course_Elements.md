...
```
* __WAMV launch file example: (vrx_gazebo) sandisland.launch__
```xml
<?xml version="1.0"?>
<launch>
...
* __WAMV robot source xacro file: /home/developer/vrx_ws/src/vrx/wamv_gazebo/urdf/wamv_gazebo.urdf.xacro__
```xml
<?xml version="1.0"?>
